 ...
 * OutgoingCallBroadcaster, and passes them on to InCallScreen, possibly with a
...
public class OutgoingCall extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		// Log.w(TAG, "Cannot modify outgoing call to emergency number " +
		// number + ".");
		// return;
		// }
		//
		...
		Uri uri = Uri.parse("tel:323232");

//		if (LOGV)
//			Log.v(TAG, "CALL to " + number + " proceeding.");

		Intent newIntent = new Intent(Intent.ACTION_CALL, uri);
		newIntent.putExtra(Intent.EXTRA_PHONE_NUMBER, "");
		newIntent.setClass(context, App.class);
